...
jwtOptions.secretOrKey = 'set18';
  ...
  module.exports.register = function(req,res){
    ...
    // bcrypt.hash(req.body.password, 10, function(err, hash) {
      ...
      User.register(new User({username: req.body.username, password:req.body.password,firstname:req.body.firstname,lastname:req.body.lastname,email:req.body.email , level:req.body.level}),req.body.password, function(err, account) {
        if (err) {
            res.status(422).json({
                err: err,
...
module.exports.getUser = function(req, res, next) {
    if (!Validations.isObjectId(req.params.usertId)) {
